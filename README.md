...
Falando em 'tecniquês', sou um mero marinho de primeira viagem. Já estudei sobre Python e C (formação básica. Entendo suas nuances, mas não tenho ainda um especialização de bibliotecas ou experiência com projetos maiores), tenho um conhecimento razoável de Node.js e NestJS (fiz alguns projetos pelo programa trainee da TITAN - Empresa Júnior de Computação da UFBA - e fui efetivado como desenvolvedor backend nessa empresa, onde trabalho atualmente), estou estudando ReactJS e mais. Busco entender, cada vez mais, sobre esse mundo da programação e me tornar a cada dia um desenvolvedor melhor que o de ontem. Sinto que é só uma questão de tempo até alcançar a excelência, aliás, ela é trivial, nada mais que fazer a mesma coisa todos os dias.
